...
public class DataManager {
    ...
    public static boolean create(DataObject data) throws Exception {
    ...
    public static byte[] read(DataObject data, int id) throws Exception {
        String filePath = ClassLoader.getSystemResource(_CONFIG.get("DIR_DATABASE") + _CONFIG.get(data.dataFile())).getPath().substring(1);
        RandomAccessFile file = new RandomAccessFile(new File(filePath), "rw");
    ...
    public static ArrayList<byte[]> read(DataObject data, int s, int n) throws Exception {
        String filePath = ClassLoader.getSystemResource(_CONFIG.get("DIR_DATABASE") + _CONFIG.get(data.dataFile())).getPath().substring(1);
        RandomAccessFile file = new RandomAccessFile(new File(filePath), "rw");
    ...
    public static boolean update(DataObject data, int id) throws Exception {
        boolean updated;
        String filePath = ClassLoader.getSystemResource(_CONFIG.get("DIR_DATABASE") + _CONFIG.get(data.dataFile())).getPath().substring(1);
        RandomAccessFile file = new RandomAccessFile(new File(filePath), "rw");
        int offset = (id - 1) * data.recordLength();
